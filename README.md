...
This project is a simple web application built using Node.js and Express. It allows users to input two numbers through a web interface and calculates their product.

## Features

<div>
  <ul>
      <li> <b>Multiplication API:</b> An API endpoint that takes two numbers as query parameters and returns their product.</li>
      <li> <b>HTML Front-end:</b> A simple web interface where users can input numbers and view the product.</li>
...
1.- Clone the repository
   ```sh
   git clone https://github.com/Retrofiyer/Multiply.git
   cd Multiply
   ```
